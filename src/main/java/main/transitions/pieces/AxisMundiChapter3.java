...
public class AxisMundiChapter3  extends Piece implements PieceInterface {
    ...
    public void startColorTransition () {
        ...
        ColorTransition transitionTriangle = new ColorTransition( getTransitionController().getMain( ).chladniForms.get( Main.ChladniFormId.TRIANGLE1 ), colorStateTriangleFrom, colorStateTriangleTo, 120000 );
        ...
        ColorTransition transitionTriangle2 = new ColorTransition( getTransitionController().getMain( ).chladniForms.get( Main.ChladniFormId.TRIANGLE1 ), colorStateTriangleFrom2, colorStateTriangleTo2, 60000 );
        ...
        ColorTransition transitionCircle = new ColorTransition( getTransitionController().getMain( ).chladniForms.get( Main.ChladniFormId.CIRCLE1 ), circleFrom, circleTo, 120000 );
        ...
        ColorTransition transitionCircle2 = new ColorTransition( getTransitionController().getMain( ).chladniForms.get( Main.ChladniFormId.CIRCLE1 ), circleFrom2, circleTo2, 60000 );
        ...
        ColorTransition transitionRect2 = new ColorTransition( getTransitionController().getMain().chladniForms.get( Main.ChladniFormId.RECT1 ), rectFrom2, rectTo2, 60000 );
