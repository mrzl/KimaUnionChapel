...
public class AuroraChapter6 extends Piece implements PieceInterface {
    ...
    public void startColorTransition () {
        ...
        ColorTransition transitionCircle = new ColorTransition( getTransitionController().getMain( ).chladniForms.get( Main.ChladniFormId.CIRCLE1 ), colorStateCircleFrom, colorStateCircleTo, 90000 );
        ...
        DirectionBlurTransition blurTransitionCircle = new DirectionBlurTransition( getTransitionController().getMain( ).chladniForms.get( Main.ChladniFormId.CIRCLE1 ), fromBlurTriangle, toBlurTriangle, 90000 );
